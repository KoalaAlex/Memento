...
class MaterialOverride extends EditorWindow {
    ...
    @MenuItem ("Window/Material Override")
    ...
    function getMaterials() {
    	if(systemParent != null){
    		...
    		if(systemParent.GetComponent(ParticleSystemRenderer).sharedMaterials.Length > 1 && systemParent.GetComponent(ParticleSystemRenderer).sharedMaterials[1] != null){
